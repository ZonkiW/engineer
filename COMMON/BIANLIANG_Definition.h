...
#define Angle_rat         -0.9//(3.5/180度) (0.58/30度)  上岛-0.8 下岛0.7

#define DOWN_Sx_rat            0//（0.8/310）
#define DOWN_Sy_rat            2.0  // 上岛 -2.0   下岛 2.2
#define DOWN_Angle_rat         0.5//(3.5/180度) (0.58/30度)  上岛-0.8 下岛0.7
...
#define CHASIS_Speedoutputmax       2500//角度（1000）左右（1500） 上岛1500 下岛1000
#define DOWN_CHASIS_Speedoutputmax  1700

#define chasis_low_step_ref         500
#define chasis_dif_step_via         1.5

#define paw_init_position           -5
#define paw_down_position           -65
#define paw_up_position             -130
#define trailer_down_position       200
#define trailer_up_position         0
...
#define forward_back_speed    600 
#define left_right_speed      600 
...
#define rotate_rat            1.0
#define P_limit_value         360//300
#define remote_lose_cut       50
#define speed_level_low_rat   0.4 //0.3
#define speed_level_hign_rat  1.5
...
#define C_ID                  0x2000
#define C_SHIFT_ID            0x2010
#define V_ID                  0x4000
#define V_SHIFT_ID            0x4010
#define B_ID                  0x8000
#define B_SHIFT_ID            0x8010
...
extern RampGen_t LOCA_SpeedRamp ;
...
extern RampGen_t paw_up_ramp ;
extern RampGen_t paw_down_ramp ;
extern RampGen_t paw_init_ramp ;
...
extern uint32_t REMOTE_LOSE_COUT;
...
extern uint16_t handle_state3;
extern uint16_t handle_state4;
extern uint32_t climb_step_count;
extern uint32_t down_step_count;
extern uint32_t paw_count;
extern uint32_t paw_control_count;
extern uint32_t paw_init_count;
extern uint16_t PAW_CHANGE_HANDLE;
extern uint16_t PAW_CHANGE_HANDLE2;
extern uint32_t can_count_1_4;
extern uint16_t paw_second_changable;

extern double paw_up_x;
extern double paw_down_x;
extern double paw_init_x;
